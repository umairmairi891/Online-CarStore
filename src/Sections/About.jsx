    ...
    <section className='bg-white'>
     <div className="flex flex-col md:grid md:grid-cols-12  " >
      <div className="col-span-6" >
        <img src="/Staff-Metting.jpeg" className='w-full opacity-60' alt="" data-aos='fade-up'/>
        <div className="p-5 text-center mt-5  lg:mt-5 ">
          <h2 className='font-bold text-2xl py-3'>Meet Out Experts</h2>
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-5" >
            <img src="/Recrutement-Marketing-Manager-scaled.jpg" className=' object-cover rounded w-full h-40' data-aos='fade-up' alt="" />
            <img src="/GettyImages-1313239835-1.webp" className=' object-cover rounded w-full h-40' alt="" data-aos='fade-up' />
            <img src="/Expert1.jfif" className=' object-cover rounded w-full h-40' alt="" data-aos='fade-up' />
            <img src="/Girl-expert.jfif" className=' object-cover rounded  w-full h-40' alt=""  data-aos='fade-up'/>
          </div>
        </div>
